                        ...
                        <form method="post" action="{{url('admin/expense/edit/'.$getRecord->id)}}">
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                    <textarea class="form-control" name="description" placeholder="Digite a descrição" required>{{$getRecord->description}}</textarea>
                                    </div>
                                </div>
                                <div class="row mb-3"><label class="col-sm-2 col-form-label">Valor
                                    ...
                                    <div class="col-sm-10"><input type="number" class="form-control" name="amount"
                                            value="{{$getRecord->amount}}" step="any" placeholder="Digite o valor" required step="any"></div>
                                </div>
